...
select bank1125.SEQ_OK_personal.Nextval,STATUS_CODE,PERSONAL_CODE,TABNO,EMP_CODE,
sysDATE,'01132',SALARY_CODE,FAMILY,FIRST_NAME,PATRONYMIC,GENDER_CODE,BIRTHDAY,REGION_ID,DISTR,
NATIONALITY_CODE,FAMILY_STATUS_CODE,REG_TYPE_CODE,HOME_ADDRESS,HOME_ADDRESSFACT,
PASS_SERIYA,PASS_NUM,PASS_DATE,PASS_REG,RECORD_BOOK_NUMBER,RECORD_BOOK_SERIES,TELEFON,
PROFMEMBER,EDUCATION_TITLE_CODE,BIRTHPLACE,BASIS_NUM,BASIS_DATE,LEAVE_CODE,NPS_ID,SPECIAL_CODE,
COD_DISTR_UVD,COD_DISTR_PRIM,COD_STR_BIRTH,COD_OBL_PRIM,COD_PLACE_BIRTH_PRIM,COD_SITIZENT,
...
APPLICATION_DATE,REPLY_DATE,IS_PARTY,IS_ACADEMIC,IS_DEGREE,IS_AWARD,IS_SCIENTIFIC,IS_VOYAGE,
IS_CONVICTIONS,IS_LANGUAGE,IS_RISE,IS_ELECTION,IS_PREMIUM,IS_ARMY
 from bank821.ok_personal where branch='00821';



prompt # :=29815 (* Ученые звания);
 insert into ok_academic (BRANCH,PERSONAL_CODE,ACADEMIC_CODE,ACADEMIC_DATE,STATE,EMP_CODE,INS_DATE) select 
        '01132',personal_code,ACADEMIC_CODE,ACADEMIC_DATE,STATE,emp_code,sysdate 
        from bank821.ok_academic 
          where branch='00821';


prompt # :=29824 (Дополнительные сведения);
 insert into OK_ADDINFORM (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, ADDINFORM_DATE,CHARACTER_ADDINFORM,ESTIMATION) select 
        '01132',personal_code,emp_code,sysdate, ADDINFORM_DATE,CHARACTER_ADDINFORM,ESTIMATION 
        from bank821.OK_ADDINFORM 
          where branch='00821'; 

prompt # :=29833 (* Воинская служба);
 insert into OK_ARMY (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       ...
       ARMY_GROUP_CODE,CATEGORY_ARMY_CODE,MILITARY_RANK_CODE,STAFF_CODE,TYPE_FORCE_CODE 
        ...
        '01132',personal_code,emp_code,sysdate,  
       ARMY_CODE,FITNESS_ARMY_CODE,SPECIAL_ARMY,NUMBER_VUS,CODE_ARMY_POST,NAME_ARMY_OFFICE,SPECREG_NUMBER, 
       ARMY_GROUP_CODE,CATEGORY_ARMY_CODE,MILITARY_RANK_CODE,STAFF_CODE,TYPE_FORCE_CODE 
        from bank821.OK_ARMY 
          where branch='00821'; 

prompt # :=29859 (* Награды);
 insert into OK_AWARD (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       AWARD_DATE,AWARD_INFO,AWARD_DATE_MM,AWARD_DATE_DD 
        ) select 
        '01132',personal_code,emp_code,sysdate,  
       AWARD_DATE,AWARD_INFO,AWARD_DATE_MM,AWARD_DATE_DD 
        from bank821.OK_AWARD 
          where branch='00821'; 

prompt # :=29871 (Командировки);
...
prompt # :=29897 (* Судимости);
 insert into OK_CONVICTIONS (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       ...
       CONVICTIONS_DATE,CONVICTIONS_MOTIVE,F1_FIO,F2_KIMNING,F3_SANA,F4_SABAB1,F4_SABAB2, 
       F4_SABAB3,F5_NATIJA1,F5_NATIJA2,F5_NATIJA3,F6_CHORA,F7_MALUMOT1,F7_MALUMOT2,CONVICTIONS_SANA 
        from bank821.OK_CONVICTIONS 
          where branch='00821'; 

prompt # :=29911 (* Ученые степени);
 insert into OK_DEGREE (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       DEGREE_CODE,DEGREE_DATE 
        ) select 
        '01132',personal_code,emp_code,sysdate,  
       DEGREE_CODE,DEGREE_DATE 
        from bank821.OK_DEGREE 
          where branch='00821'; 

prompt # :=29923 (* Образование);
 insert into OK_EDUCATION (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       ...
       EDUCATION_CODE,BASIS_CODE,INSTITUTION_CODE,BEGIN_DATE,END_DATE,PROFESSION_PERSONAL, 
         ...
         NOSTRA_DATE,DIPLOM_DATE,BEGIN_DATE_MM,BEGIN_DATE_DD, 
         END_DATE_MM,END_DATE_DD,EDUCATION_END,EDUCATION_CITY,EDUCATION_COUNT_CODE,VID_EDUCATION_CODE 
        from bank821.OK_EDUCATION 
          where branch='00821'; 

prompt # :=29941 (* Избрание);
...
prompt # :=29995 (* Языки);
 insert into OK_LANGUAGE (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       LANGUAGE_CODE,LEVEL_CODE,STATE,COD_LANG_PRIM 
        ...
        '01132',personal_code,emp_code,sysdate,  
       LANGUAGE_CODE,LEVEL_CODE,STATE,COD_LANG_PRIM 
        from bank821.OK_LANGUAGE 
          where branch='00821'; 

{prompt # :=30007 (Отпуска же не надо копировать);
...
prompt # :=30021 (* Партии);
 insert into OK_PARTY (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       PARTY_CODE,OUT_PARTY,PARTY_DATE,PARTY_OUTDATE,PUNISHMENT_MOTIVE,PUNISHMENT_DATE,CODE_PARTII_PRIM 
        ...
        '01132',personal_code,emp_code,sysdate,  
       PARTY_CODE,OUT_PARTY,PARTY_DATE,PARTY_OUTDATE,PUNISHMENT_MOTIVE,PUNISHMENT_DATE,CODE_PARTII_PRIM 
        from bank821.OK_PARTY 
          where branch='00821'; 

prompt # :=30033 (Сведения о взысканиях);
 insert into OK_PENALTY (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE,  
       PENALTY_CODE,PENALTY_MOTIVE,PENALTY_DATE,PENALTY_NUM 
        ) select 
        '01132',personal_code,emp_code,sysdate,  
       PENALTY_CODE,PENALTY_MOTIVE,PENALTY_DATE,PENALTY_NUM 
        from bank821.OK_PENALTY 
          where branch='00821'; 

prompt # :=30045 (* Сведения о работе (МЕХНАТ ФАОЛИЯТИ));
...
prompt # :=30071 (Льготы);
 insert into OK_PRIVILEGE (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       PRIVILEGE_CODE,PRIVILEGE_DOC,DATE_OPEN,DATE_CLOSE,PRIM 
        ...
        '01132',personal_code,emp_code,sysdate,  
       PRIVILEGE_CODE,PRIVILEGE_DOC,DATE_OPEN,DATE_CLOSE,PRIM 
        from bank821.OK_PRIVILEGE 
          where branch='00821'; 

prompt # :=30083 (* Родственные отношения);
