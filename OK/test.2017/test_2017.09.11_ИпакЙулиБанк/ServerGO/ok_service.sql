...
IS
  Version constant char(12) := '#~11092017~#';
...
--  30.06.2017 теперь и в Давр подтв. в ГО
...
-- проверка разрешения ГО 08.11.2012 .
  if (head_ ='09006') or (head_ ='09049') or (head_ ='09014') or (head_ ='09004') or (head_ ='09051') -- 22,04,2014 теперь в агро подтв. в ГО на увольнение Нужно.
...
--      and (head_ ='09006')  --((head_ ='09006') or (head_ ='09004')) --  агро подтв. в ГО На увольнение Нужно
      and ((head_ ='09006') or (head_ ='09049') or (head_ ='09014') or (head_ ='09004') or (head_ ='09051') )
--  and (branch_ in ('00000','00703'))
    then
...
-- проверка разрешения ГО
  if --(head_ ='09006') --or (head_ ='09004')) -- 08.11.2012 теперь и в агро подтверждение в ГО
       ((head_ ='09006') or (head_ ='09049') or (head_ ='09014') or (head_ ='09004') or (head_ ='09051') )
--  and (branch_ in ('00000','00703'))
  then
--
