...
insert into SS_OK_PERS_COL_DFLT values('001','05','OK_SERVICE.GET_SPECIALNAME(PP.SPECIAL_CODE)','C','Специализация','Специализация',13,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','06','PP.FAMILY','C','Фамилия','Фамилия',20,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','07','PP.FIRST_NAME','C','Имя','Имя',20,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','08','PP.PATRONYMIC','C','Отчество','Отчество',20,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','09','OK_SERVICE.GET_GENDERNAME(PP.GENDER_CODE)','C','Пол','Пол',3,null,'select to_char(gender_code) id,gender_name name from ss_ok_gender');
insert into SS_OK_PERS_COL_DFLT values('001','10','PP.BIRTHDAY','D','День рождения','День рожд.',10,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','11','OK_SERVICE.GET_REGIONNAME(PP.REGION_ID)','C','Место рождения (область)','Место рождения (обл)',20,null,'select region_id id,region_nam name from s_region');
insert into SS_OK_PERS_COL_DFLT values('001','12','OK_SERVICE.GET_DISTRNAME(PP.DISTR)','C','Место рождения (город)','Место рождения (город)',20,null,'select distr id, distr_name name from s_distr');
insert into SS_OK_PERS_COL_DFLT values('001','13','OK_SERVICE.GET_BIRTHPLACE(PP.BIRTHPLACE,PP.REGION_ID,PP.DISTR)','C','Место рождения (обл,город или не Узбекистан)','Место рождения',30,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','14','PP.BIRTHPLACE','C','Место рождения (иностр)','Место рождения (иностр)',30,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','15','OK_SERVICE.GET_NATIONALITYNAME(PP.NATIONALITY_CODE)','C','Национальность','Национальность',10,null,'select to_char(nationality_code) id, nationality_name name from ss_ok_nationality where state_notes=''A'' ');
insert into SS_OK_PERS_COL_DFLT values('001','16','OK_SERVICE.GET_FAMILYSTATUSNAME(PP.FAMILY_STATUS_CODE)','C','Семейное положение','Семейное положение',10,null,'select family_status_code id, family_status_name name from ss_ok_family_status');
insert into SS_OK_PERS_COL_DFLT values('001','17','OK_SERVICE.GET_REGTYPENAME(PP.REG_TYPE_CODE)','C','Тип прописки','Прописка',10,null,'select reg_type_code id, reg_type_name name from ss_ok_reg_type');
insert into SS_OK_PERS_COL_DFLT values('001','18','PP.HOME_ADDRESS','C','Полный домашний адрес (прописка)','Полный домашний адрес (прописка)',30,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','19','PP.HOME_ADDRESSFACT','C','Фактическое место проживания','Фактическое место проживания',30,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','20','PP.PASS_SERIYA','C','Серия паспорта','Серия паспорта',2,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','21','PP.PASS_NUM','C','Номер паспорта','N паспорта',7,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','22','PP.PASS_DATE','D','Дата выдачи паспорта','Дата выдачи паспорта',10,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','23','PP.PASS_REG','C','Место выдачи паспорта','Место выдачи паспорта',30,null,null);
...
insert into SS_OK_PERS_COL_DFLT values('001','25','PP.RECORD_BOOK_NUMBER','C','Номер трудовой книжки','N трудовой книжки',10,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','26','PP.TELEFON','C','Телефон','Телефон',10,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','27','OK_SERVICE.GET_PROFMEMBERNAME(PP.PROFMEMBER)','C','Профсоюз','Профсоюз',3,null,'select profmember_code id, profmember_name name from ss_ok_profmember');
insert into SS_OK_PERS_COL_DFLT values('001','28','OK_SERVICE.GET_EDUCATIONTITLENAME(PP.EDUCATION_TITLE_CODE)','C','Образование','Образование',10,null,'select to_char (EDUCATION_TITLE_CODE) id, EDUCATION_TITLE_NAME name from SS_OK_EDUCATION_TITLE');
insert into SS_OK_PERS_COL_DFLT values('001','29','PP.TABNO','C','Табельный номер','Табельный номер',9,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','30','PP.NPS_ID','C','Пенсионный ИН','Пенсионный ИН',9,null,null);
