...
begin
  ...
  if id_ is null then
    insert into apps values(seq_apps.nextval, 'Кадры - справочники', 'OKRef.bpl', 'TBOKRefForm', 'ICON96', '1.0.0.2', 'Кадры - справочники', '23', 1, 0);
  else 
...
begin
  ...
  if id_ is null then
    insert into apps values(seq_apps.nextval, 'Кадры', 'OK.bpl', 'TBOKForm', 'ICON96', '1.0.0.2', 'Кадры', '23', 1, 0);
  else 
    Update Apps Set Version = '1.0.0.2',GROUP_ID=23
...
begin
  ...
  if id_ is null then
    insert into apps values(seq_apps.nextval, 'Кадры - генератор отчетов', 'OKOrder.bpl', 'TBOKOrderForm', 'ICON96', '1.0.0.0', 'Кадры - генератор отчетов', '23', 1, 0);
  else
