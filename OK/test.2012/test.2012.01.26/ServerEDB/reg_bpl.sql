    ...
    Update Apps Set Package_Name='OK_EDB.BPL',Version = '1.0.2.2',name='Кадры ГО',SHORT_DESC ='Кадры ГО',
...
alter trigger tr_apps enable;
    ...
    Update Apps Set  Version = '1.0.2.2',name='Кадры ГО',SHORT_DESC ='Кадры ГО',
     class_name='TBOKEDBForm'
