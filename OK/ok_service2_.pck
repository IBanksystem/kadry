...
-- ни серия ни номер не зименились - это 2 Изменение
  ...
  then
    ...
    then  -- без изменения паспорта и номера- это 2 Изменение
      NOM_UI_:='09_001';
      MY_ACTION_HIST_ID_ := 2;
    else -- изменение паспорта или номера- это 4 Изменение паспорта
      NOM_UI_:='09_012';
...
--    if (TABLE_NAME_='OK_') then NOM_UI_:='09_012'; end if; изменение паспорта выбрано выше
  end if;
