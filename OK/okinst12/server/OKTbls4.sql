...
comment on table ss_ok_org_business_voyage is 'справочник «Организатор проведения командировки»';
comment on column ss_ok_org_business_voyage.org_business_voyage_code is 'код';
comment on column ss_ok_org_business_voyage.org_business_voyage_name is 'название';
comment on column ss_ok_org_business_voyage.STATE_NOTES is 'A-активный';
comment on column ss_ok_org_business_voyage.EMP_CODE is 'код сотрудника ОК';
comment on column ss_ok_org_business_voyage.INS_DATE is 'дата вставки записи';
...
comment on table ss_ok_theme_business_voyage is 'справочник «Тема командировки»';
comment on column ss_ok_theme_business_voyage.theme_business_voyage_code is 'код';
comment on column ss_ok_theme_business_voyage.theme_business_voyage_name is 'название';
comment on column ss_ok_theme_business_voyage.STATE_NOTES is 'A-активный';
comment on column ss_ok_theme_business_voyage.EMP_CODE is 'код сотрудника ОК';
comment on column ss_ok_theme_business_voyage.INS_DATE is 'дата вставки записи';
...
comment on table ss_ok_increase is 'справочник «надбавки»';
comment on column ss_ok_increase.increase_code is 'код Вид надбавки – 1Персональная надбавка, 2Надбавка за  совмещение';
comment on column ss_ok_increase.increase_name is 'Вид надбавки – 1Персональная надбавка, 2Надбавка за  совмещение';

ALTER TABLE ss_ok_increase ADD CONSTRAINT ss_ok_increase_PK
  PRIMARY KEY (  increase_CODE  );

delete from ss_ok_increase;
insert into ss_ok_increase select 1,'Персональная надбавка' from dual;
insert into ss_ok_increase select 2,'Надбавка за  совмещение' from dual;
commit;
...
comment on column ss_ok_privilege.privilege_code   is 'код Вид льготы ss_ok_privilege';
comment on column ss_ok_privilege.privilege_name   is 'наименование Вид льготы ss_ok_privilege';
comment on column ss_ok_privilege.STATE_NOTES is 'A-активный';
comment on column ss_ok_privilege.EMP_CODE is 'код сотрудника ОК';
comment on column ss_ok_privilege.INS_DATE is 'дата вставки записи';
