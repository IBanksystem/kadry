...
begin
  ...
  -- уволить внештат с истекшим сроком
...
--  if is_vnestat_=0
--  then
       -- внештатных не брать НЕ УДАЛОСЬ
       -- Интегрированная Банковская Система
--(2475) не удалось подтвердитьORA-04091: table BANK049.OK_PERSONAL is mutating, trigger/function may not see it
--ORA-06512: at "BANK394.OK_SERVICE2", line 88
--ORA-06512: at "BANK049.TR_OK_PERSONAL_HIST", line 143
--ORA-04088: error during execution of trigger 'BANK049.TR_OK_PERSONAL_HIST'
    if v_date_2 is null
    then
