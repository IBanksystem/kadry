...
alter table IY01028.OK_PERIOD add MOTIVE_OUT             VARCHAR2(150);

drop trigger IY01028.TR_OK_PERIOD_HIST;

alter table IY01028.OK_PERIOD
  drop constraint OK_PERIOD_PK;
drop index  OK_PERIOD_PK;

alter table IY01028.OK_PERIOD
  drop constraint OK_PERIOD_UK;
drop index  IY01028.OK_PERIOD_UK;




drop table ok_period_old;
alter table IY01028.ok_period rename to ok_period_old;
create table ok_period as select * from IY00444.ok_period where rownum<1;
commit;
insert into IY01028.ok_period (
 ID, 
 BRANCH, 
 PERSONAL_CODE,
 IN_OFFICE_DATE, 
