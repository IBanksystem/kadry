spool c:\run_del01140_4.txt
prompt # удаление

delete from ok_personal where branch='01140' and tabno in (778,786,804,932);
commit;

delete from ok_academic
where branch='01140' and personal_code not in (select personal_code from ok_personal where branch='01140');       
...
commit;
delete from ok_hist where branch='01140';
commit;
