...
insert into SS_OK_PERS_COL_DFLT values('001','18','PP.HOME_ADDRESS','C','Полный домашний адрес (прописка)','Полный домашний адрес (прописка)',30,null,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','19','PP.HOME_ADDRESSFACT','C','Фактическое место проживания','Фактическое место проживания',30,null,null,null);
...
insert into SS_OK_PERS_COL_DFLT values('001','24','PP.RECORD_BOOK_SERIES','C','Серия трудовой книжки','Серия трудовой книжки',5,null,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','25','PP.RECORD_BOOK_NUMBER','C','Номер трудовой книжки','N трудовой книжки',10,null,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','26','PP.TELEFON','C','Телефон','Телефон',10,null,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','27','OK_SERVICE.GET_PROFMEMBERNAME(PP.PROFMEMBER)','C','Профсоюз','Профсоюз',3,null,'select profmember_code id, profmember_name name from ss_ok_profmember',null);
insert into SS_OK_PERS_COL_DFLT values('001','28','OK_SERVICE.GET_EDUCATIONTITLENAME(PP.EDUCATION_TITLE_CODE)','C','Образование','Образование',10,null,'select to_char (EDUCATION_TITLE_CODE) id, EDUCATION_TITLE_NAME name from SS_OK_EDUCATION_TITLE',null);
insert into SS_OK_PERS_COL_DFLT values('001','29','PP.TABNO','C','Табельный номер','Табельный номер',9,null,null,null);
insert into SS_OK_PERS_COL_DFLT values('001','30','PP.NPS_ID','C','Пенсионный ИН','Пенсионный ИН',9,null,null,null);
...
insert into SS_OK_PERS_COL_DFLT values('004','03','ok_service.get_staffname(AR.STAFF_CODE)','C','Вид состава','Вид состава',15,null,null);
insert into SS_OK_PERS_COL_DFLT values('004','04','ok_service.get_typeforcename(AR.TYPE_FORCE_CODE)','C','Род войск','Род войск',15,null,null);
insert into SS_OK_PERS_COL_DFLT values('004','05','ok_service.get_armygroupname(AR.ARMY_GROUP_CODE)','C','Группа учета','Гр.учета',15,null,null);
insert into SS_OK_PERS_COL_DFLT values('004','06','ok_service.get_categoryarmyname(AR.CATEGORY_ARMY_CODE)','C','Категория учета','Категория учета',15,null,null);
insert into SS_OK_PERS_COL_DFLT values('004','07','AR.SPECIAL_ARMY','C','Воинская Специальность','Воинская Спец-ть',15,null,null);
insert into SS_OK_PERS_COL_DFLT values('004','08','ok_service.get_militaryrankname(AR.MILITARY_RANK_CODE)','C','Воинское звание','Воинское звание',15,null,null);
