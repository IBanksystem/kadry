...
begin
  ...
  if id_ is null then
    insert into apps values(seq_apps.nextval, 'Кадры - справочники', 'OKRef.bpl', 'TBOKRefForm', 'ICON96', '1.0.0.2', 'Кадры - справочники', null, 1, 0);
  else 
    Update Apps Set Version = '1.0.0.2',GROUP_ID=null
...
begin
  ...
  if id_ is null then
    insert into apps values(seq_apps.nextval, 'Кадры', 'OK.bpl', 'TBOKForm', 'ICON96', '1.0.0.2', 'Кадры', null, 1, 0);
  else 
    Update Apps Set Version = '1.0.0.2',GROUP_ID=null
