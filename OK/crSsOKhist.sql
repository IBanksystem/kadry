...
insert into ss_ok_action_hist values (3,'Удаление');
insert into ss_ok_action_hist values (4,'Изменение паспорта');
commit;
...
create index ok_hist_PK on ok_hist (BRANCH, PERSONAL_CODE, V_DATE, INS_DATE);
