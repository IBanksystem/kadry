prompt Created on 28.08.2013 by user
set feedback off
set define off
prompt Deleting SS_OK_PERS_COL_DFLT...
...
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '23', 'OK_SERVICE.GET_DISTRNAME(PP.COD_DISTR_UVD)', 'C', 'Место выдачи паспорта', 'Место выдачи паспорта', 30, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
...
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '26', 'PP.RECORD_BOOK_SERIES', 'C', 'Серия трудовой книжки', 'Серия трудовой книжки', 5, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '27', 'PP.RECORD_BOOK_NUMBER', 'C', 'Номер трудовой книжки', 'N трудовой книжки', 10, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '28', 'PP.TELEFON', 'C', 'Телефон', 'Телефон', 10, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '29', 'OK_SERVICE.GET_PROFMEMBERNAME(PP.PROFMEMBER)', 'C', 'Профсоюз', 'Профсоюз', 3, null, 'select profmember_code id, profmember_name name from ss_ok_profmember', null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '30', 'OK_SERVICE.GET_EDUCATIONTITLENAME(PP.EDUCATION_TITLE_CODE)', 'C', 'Образование', 'Образование', 10, null, 'select to_char (EDUCATION_TITLE_CODE) id, EDUCATION_TITLE_NAME name from SS_OK_EDUCATION_TITLE', null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '31', 'PP.TABNO', 'C', 'Табельный номер', 'Табельный номер', 9, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '32', 'PP.NPS_ID', 'C', 'Пенсионный ИН', 'Пенсионный ИН', 9, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('001', '33', 'PP.INN', 'C', 'ИНН', 'ИНН', 9, null, null, null);
...
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('003', '03', 'AD.ESTIMATION', 'C', 'Оценка', 'Оценка', 30, null, null, null);
...
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('023', '01', 'KU.KV_KURS_CODE', 'N', 'Код курсов', 'Код курсов', 9, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
values ('023', '02', 'KU.FIO', 'C', 'ФИО', 'ФИО', 150, null, null, null);
insert into SS_OK_PERS_COL_DFLT (CODE_TABLE, CODE_NUM, NAME, COL_TYPE, NAME_DISPL, NAME_PAPER, LEN, CODE_LOOK_UP, SEL_SQL, REAL_NAME)
