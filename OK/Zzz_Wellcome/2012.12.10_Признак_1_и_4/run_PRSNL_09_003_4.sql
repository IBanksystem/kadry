spool c:\err09_003_4.txt

declare
  V_DATE_ date :=to_date('05.01.2015','dd.mm.yyyy');
  branch_ branch.bank_id%type;
  personal_code_ ok_personal.personal_code%type :=820;  -- personal_code_ сотрудника
begin
  select bank_id into branch_ from branch;
    delete from ok_hist where branch=branch_ and nom_ui in ('09_003') and personal_code=personal_code_;
