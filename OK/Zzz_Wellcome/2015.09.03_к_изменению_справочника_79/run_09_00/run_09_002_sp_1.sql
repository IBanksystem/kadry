...
begin
  select bank_id into branch_ from branch;
    delete from ok_hist where branch=branch_ and nom_ui in ('09_002') and personal_code in (74,98,170);
  ...
  where okp.tabno=okp.tabno
   and okp.branch=okp.branch and okp.STATUS_CODE in (2,5)
         ...
         and okp.branch=branch_  and personal_code in (74,98,170))
  loop
