...
IS
  Version constant char(12) := '#~16092013~#';
...
-- проверка разрешения ГО 08.11.2012 .
  if (head_ ='09006') --or (head_ ='09004') в агро подтв. в ГО на увольнение не нужно.
...
--      and (head_ ='09006')  --((head_ ='09006') or (head_ ='09004')) --  агро подтв. в ГО На увольнение не нужно
