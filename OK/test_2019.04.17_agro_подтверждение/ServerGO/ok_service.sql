...
IS
  Version constant char(12) := '#~17042019~#';
...
-- 17.04.2019 теперь и в агро подтверждение в ГО только в трех областях и одному сотруднику 
  or   (head_ ='09049') or (head_ ='09014') or (head_ ='*****') or (head_ ='*****') 
--  and (branch_ in ('00000','00703'))
  then
--
