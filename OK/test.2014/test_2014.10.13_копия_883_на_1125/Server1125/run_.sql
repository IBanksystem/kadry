...
sysDATE,'01125',SALARY_CODE,FAMILY,FIRST_NAME,PATRONYMIC,GENDER_CODE,BIRTHDAY,REGION_ID,DISTR,
NATIONALITY_CODE,FAMILY_STATUS_CODE,REG_TYPE_CODE,HOME_ADDRESS,HOME_ADDRESSFACT,
PASS_SERIYA,PASS_NUM,PASS_DATE,PASS_REG,RECORD_BOOK_NUMBER,RECORD_BOOK_SERIES,TELEFON,
PROFMEMBER,EDUCATION_TITLE_CODE,BIRTHPLACE,BASIS_NUM,BASIS_DATE,LEAVE_CODE,NPS_ID,SPECIAL_CODE,
COD_DISTR_UVD,COD_DISTR_PRIM,COD_STR_BIRTH,COD_OBL_PRIM,COD_PLACE_BIRTH_PRIM,COD_SITIZENT,
...
APPLICATION_DATE,REPLY_DATE,IS_PARTY,IS_ACADEMIC,IS_DEGREE,IS_AWARD,IS_SCIENTIFIC,IS_VOYAGE,
IS_CONVICTIONS,IS_LANGUAGE,IS_RISE,IS_ELECTION,IS_PREMIUM,IS_ARMY
 from bank883.ok_personal where branch='00883';



--:=29815 (* Ученые звания);
 insert into ok_academic (BRANCH,PERSONAL_CODE,ACADEMIC_CODE,ACADEMIC_DATE,STATE,EMP_CODE,INS_DATE) select 
        '01125',personal_code,ACADEMIC_CODE,ACADEMIC_DATE,STATE,emp_code,sysdate 
        from bank883.ok_academic 
          where branch='00883';
...
--:=29824 (Дополнительные сведения);
 insert into OK_ADDINFORM (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, ADDINFORM_DATE,CHARACTER_ADDINFORM,ESTIMATION) select 
        '01125',personal_code,emp_code,sysdate, ADDINFORM_DATE,CHARACTER_ADDINFORM,ESTIMATION 
        from bank883.OK_ADDINFORM 
          where branch='00883'; 
...
--:=29833 (* Воинская служба);
 insert into OK_ARMY (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       ...
       ARMY_GROUP_CODE,CATEGORY_ARMY_CODE,MILITARY_RANK_CODE,STAFF_CODE,TYPE_FORCE_CODE 
        ...
        '01125',personal_code,emp_code,sysdate,  
       ARMY_CODE,FITNESS_ARMY_CODE,SPECIAL_ARMY,NUMBER_VUS,CODE_ARMY_POST,NAME_ARMY_OFFICE,SPECREG_NUMBER, 
       ARMY_GROUP_CODE,CATEGORY_ARMY_CODE,MILITARY_RANK_CODE,STAFF_CODE,TYPE_FORCE_CODE 
        from bank883.OK_ARMY 
          where branch='00883'; 

{--:=29847 нигде не используется?;
 insert into OK_ATTESTATION (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       DATE_ATTESTATION,NUM_ATTESTATION 
        ) select 
        '01125',personal_code,emp_code,sysdate,  
       DATE_ATTESTATION,NUM_ATTESTATION 
        from bank883.OK_ATTESTATION 
          where branch='00883'; 
}
--:=29859 (* Награды);
...
--:=29871 (Командировки);
 insert into OK_BUSINESS_VOYAGE (BRANCH,PERSONAL_CODE,EMP_CODE,INS_DATE, 
       ...
       CITY_CODE,KV_KURS_CODE,DATE_OPEN,DATE_CLOSE,NUMBER_DAY,ORG_BUSINESS_VOYAGE_CODE, 
       THEME_BUSINESS_VOYAGE_CODE,CODE_STR,ORDER_NUM,ORDER_DATE,PRIM 
        from bank883.OK_BUSINESS_VOYAGE 
          where branch='00883'; 
