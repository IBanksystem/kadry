...
loop
  ...
  then
    ...
    -- удаление insert into ok_hist_table (part1) values (part2)
     ...
     inc(id_); insert into rep_temp (id,name_1) values (id_,' Version constant char(12) := ''#~11102011~#'';');
     inc(id_); insert into rep_temp (id,name_1) values (id_,' new_id NUMBER;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,' branch_ ok_personal.branch%type;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,' personal_code_ ok_personal.personal_code%type;');
     ...
     inc(id_); insert into rep_temp (id,name_1) values (id_,'    branch_:=:NEW.branch;personal_code_:=:NEW.PERSONAL_CODE;new_id:=1;');
     ...
     inc(id_); insert into rep_temp (id,name_1) values (id_,'    branch_:=:NEW.branch;personal_code_:=:NEW.PERSONAL_CODE;new_id:=2;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'  end if;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'  if deleting then ');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'    branch_:=:OLD.branch;personal_code_:=:OLD.PERSONAL_CODE;new_id:=3;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'  end if;');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'  if ok_service2.is_boss_now(branch_,personal_code_)=1 then');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'    ok_service2.ok_hist_proc(branch_,personal_code_,'''||old_tbl||''',new_id,null,null,null,null,null,null);');
     inc(id_); insert into rep_temp (id,name_1) values (id_,'  end if;');
